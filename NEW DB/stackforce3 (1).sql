...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 01 Février 2016 à 00:32
...
(1, 57, 'Le jQuery est une bibliothèque JavaScript permettant de simplifier grandement le code. En revanche, pour utiliser du jQuery, il faut importer la bibliothèque, soit en téléchargeant les fichiers nécessaires, soit en copiant le lien de la dernière version du CDN dans l''index de ton site web.', 0, 1, '2016-01-27 00:00:00'),
(2, 57, 'Comment faire pour convertir une date en PHP ? Répondez-moi vite s''il vous plait !', 0, 1, '2016-01-28 00:00:00'),
(3, 57, 'Avec du padding bien sûr !', 0, 5, '2016-01-30 00:16:53'),
(4, 57, 'Essaye ça : \r\n\r\n$(window).scroll(function(){\r\n		if ($(this).scrollTop() > 100) {\r\n			$(''.scrollToTop'').fadeIn();\r\n		} else {\r\n			$(''.scrollToTop'').fadeOut();\r\n		}\r\n	});\r\n	\r\n	$(''.scrollToTop'').click(function(){\r\n		$(''html, body'').animate({scrollTop : 0},800);\r\n		return false;\r\n	});', 0, 10, '2016-01-30 04:17:13'),
